...
import DistributionGroupPure from './DistributionGroupPure';
import Typography from '@mui/material/Typography';
import {DIST_PLOT_OPTIONS, DISTRIBUTION_PLOT_INTERPOLATOR_OBJ} from './reducers';


function DistributionPlotsPure(props) {
    ...
    return keys.map(key => {
        ...
        return <div key={key}><Typography color="textPrimary"
            ...
            return <DistributionGroupPure key={dimension}
